...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__wobble" src="{{ asset('dashboard/assets/dist/img/AdminLTELogo.png')}}" alt="AdminLTELogo" height="60" width="60">
    </div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="direct-chat-contacts">
                        <ul class="contacts-list">
                          ...
                          <li>
                            <a href="#">
                              <img class="contacts-list-img" src="{{ asset('dashboard/assets/dist/img/user5-128x128.jpg')}}" alt="User Avatar">
                          ...
                          <li>
                            <a href="#">
                              <img class="contacts-list-img" src="{{ asset('dashboard/assets/dist/img/user6-128x128.jpg')}}" alt="User Avatar">
                  ...
                  <ul class="products-list product-list-in-card pl-2 pr-2">
                    <li class="item">
                      <div class="product-img">
                        <img src="{{ asset('dashboard/assets/dist/img/default-150x150.png')}}" alt="Product Image" class="img-size-50">
                      </div>
